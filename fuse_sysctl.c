...
SYSCTL_DECL(_fuse4x);
SYSCTL_NODE(, OID_AUTO, fuse4x, CTLFLAG_RW, 0,
            "fuse4x Sysctl Interface");
SYSCTL_NODE(_fuse4x, OID_AUTO, control, CTLFLAG_RW, 0,
            "fuse4x Controls");
SYSCTL_NODE(_fuse4x, OID_AUTO, counters, CTLFLAG_RW, 0,
            "fuse4x Monotonic Counters");
SYSCTL_NODE(_fuse4x, OID_AUTO, resourceusage, CTLFLAG_RW, 0,
            "fuse4x Resource Usage");
SYSCTL_NODE(_fuse4x, OID_AUTO, tunables, CTLFLAG_RW, 0,
            "fuse4x Tunables");
SYSCTL_NODE(_fuse4x, OID_AUTO, version, CTLFLAG_RW, 0,
...
SYSCTL_PROC(_fuse4x_control, // our parent
...
/* fuse.counters */
SYSCTL_INT(_fuse4x_counters, OID_AUTO, filehandle_reuse, CTLFLAG_RD,
           &fuse_fh_reuse_count, 0, "");
SYSCTL_INT(_fuse4x_counters, OID_AUTO, filehandle_upcalls, CTLFLAG_RD,
           &fuse_fh_upcall_count, 0, "");
SYSCTL_INT(_fuse4x_counters, OID_AUTO, lookup_cache_hits, CTLFLAG_RD,
           &fuse_lookup_cache_hits, 0, "");
SYSCTL_INT(_fuse4x_counters, OID_AUTO, lookup_cache_misses, CTLFLAG_RD,
           &fuse_lookup_cache_misses, 0, "");
SYSCTL_INT(_fuse4x_counters, OID_AUTO, lookup_cache_overrides,
           CTLFLAG_RD, &fuse_lookup_cache_overrides, 0, "");
SYSCTL_INT(_fuse4x_counters, OID_AUTO, memory_reallocs, CTLFLAG_RD,
           &fuse_realloc_count, 0, "");

/* fuse.resourceusage */
SYSCTL_INT(_fuse4x_resourceusage, OID_AUTO, filehandles, CTLFLAG_RD,
           &fuse_fh_current, 0, "");
SYSCTL_INT(_fuse4x_resourceusage, OID_AUTO, filehandles_zombies, CTLFLAG_RD,
           &fuse_fh_zombies, 0, "");
SYSCTL_INT(_fuse4x_resourceusage, OID_AUTO, ipc_iovs, CTLFLAG_RD,
           &fuse_iov_current, 0, "");
SYSCTL_INT(_fuse4x_resourceusage, OID_AUTO, ipc_tickets, CTLFLAG_RD,
           &fuse_tickets_current, 0, "");
SYSCTL_INT(_fuse4x_resourceusage, OID_AUTO, memory_bytes, CTLFLAG_RD,
           &fuse_memory_allocated, 0, "");
SYSCTL_INT(_fuse4x_resourceusage, OID_AUTO, mounts, CTLFLAG_RD,
           &fuse_mount_count, 0, "");
SYSCTL_INT(_fuse4x_resourceusage, OID_AUTO, vnodes, CTLFLAG_RD,
           &fuse_vnodes_current, 0, "");

/* fuse.tunables */
SYSCTL_INT(_fuse4x_tunables, OID_AUTO, admin_group, CTLFLAG_RW,
           &fuse_admin_group, 0, "");
SYSCTL_INT(_fuse4x_tunables, OID_AUTO, allow_other, CTLFLAG_RW,
           &fuse_allow_other, 0, "");
SYSCTL_INT(_fuse4x_tunables, OID_AUTO, iov_credit, CTLFLAG_RW,
           &fuse_iov_credit, 0, "");
SYSCTL_INT(_fuse4x_tunables, OID_AUTO, iov_permanent_bufsize, CTLFLAG_RW,
           &fuse_iov_permanent_bufsize, 0, "");
SYSCTL_INT(_fuse4x_tunables, OID_AUTO, max_freetickets, CTLFLAG_RW,
           &fuse_max_freetickets, 0, "");
SYSCTL_INT(_fuse4x_tunables, OID_AUTO, max_tickets, CTLFLAG_RW,
           &fuse_max_tickets, 0, "");
SYSCTL_PROC(_fuse4x_tunables,          // our parent
            OID_AUTO,                   // automatically assign object ID
...
/* fuse.version */
SYSCTL_INT(_fuse4x_version, OID_AUTO, api_major, CTLFLAG_RD,
           &fuse_api_major, 0, "");
SYSCTL_INT(_fuse4x_version, OID_AUTO, api_minor, CTLFLAG_RD,
           &fuse_api_minor, 0, "");
SYSCTL_STRING(_fuse4x_version, OID_AUTO, number, CTLFLAG_RD,
              FUSE4X_VERSION, 0, "");
SYSCTL_STRING(_fuse4x_version, OID_AUTO, string, CTLFLAG_RD,
              FUSE4X_VERSION ", " FUSE4X_TIMESTAMP, 0, "");

static struct sysctl_oid *fuse_sysctl_list[] =
{
    &sysctl__fuse4x_control,
    &sysctl__fuse4x_counters,
    &sysctl__fuse4x_resourceusage,
    &sysctl__fuse4x_tunables,
    &sysctl__fuse4x_version,
    &sysctl__fuse4x_control_kill,
    &sysctl__fuse4x_control_print_vnodes,
    &sysctl__fuse4x_counters_filehandle_reuse,
    &sysctl__fuse4x_counters_filehandle_upcalls,
    &sysctl__fuse4x_counters_lookup_cache_hits,
    &sysctl__fuse4x_counters_lookup_cache_misses,
    &sysctl__fuse4x_counters_lookup_cache_overrides,
    &sysctl__fuse4x_counters_memory_reallocs,
    &sysctl__fuse4x_resourceusage_filehandles,
    &sysctl__fuse4x_resourceusage_filehandles_zombies,
    &sysctl__fuse4x_resourceusage_ipc_iovs,
    &sysctl__fuse4x_resourceusage_ipc_tickets,
    &sysctl__fuse4x_resourceusage_memory_bytes,
    &sysctl__fuse4x_resourceusage_mounts,
    &sysctl__fuse4x_resourceusage_vnodes,
    &sysctl__fuse4x_tunables_admin_group,
    &sysctl__fuse4x_tunables_allow_other,
    &sysctl__fuse4x_tunables_iov_credit,
    &sysctl__fuse4x_tunables_iov_permanent_bufsize,
    &sysctl__fuse4x_tunables_max_freetickets,
    &sysctl__fuse4x_tunables_max_tickets,
    &sysctl__fuse4x_tunables_userkernel_bufsize,
    &sysctl__fuse4x_version_api_major,
    &sysctl__fuse4x_version_api_minor,
    &sysctl__fuse4x_version_number,
    &sysctl__fuse4x_version_string,
    (struct sysctl_oid *)0
};
...
fuse_sysctl_start(void)
{
    ...
    sysctl_register_oid(&sysctl__fuse4x);
...
fuse_sysctl_stop(void)
{
    ...
    sysctl_unregister_oid(&sysctl__fuse4x);
}
